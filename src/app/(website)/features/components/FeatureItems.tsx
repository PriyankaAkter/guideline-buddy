...
const FeatureItems = () => {
  return (
    ...
    //     <div
    //       className="w-[1167px] h-[1642px] py-[118px] px-[189px] mx-auto grid gap-28 rounded-se-[60px] rounded-es-[60px] absolute ml-[195px] z-10"
    //       style={{
    //         boxShadow: "0px 0px 33.8px 0px rgba(0, 0, 0, 0.08)",
    ...
    //     </div>
    //     <div
    //     className="w-[1362px] h-[1799px] mx-auto sb absolute z-0"
    //     style={{
    //       backgroundImage: `url(/assets/images/bg-gradient.png)`,
    //       backgroundRepeat: "no-repeat",
    //     }}
