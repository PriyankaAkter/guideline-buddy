...
const HomeVision = () => {
  return (
    <div className='py-[80px] lg:py-[160px] container'>
      <div className='xl:w-[900px] mx-auto text-center flex flex-col items-center gap-10 '>
        ...
        <p className=' text-center'>
            We&apos;re on a mission to transform the mortgage landscape, making
          it accessible, efficient, and fair for all. Discover how we blend
