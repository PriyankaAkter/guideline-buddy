...
const HomeInnovation = () => {
  return (
    <div className='bg-gradient-to-b xl:bg-gradient-to-r from-[#5437CC] from-[30%] xl:from-[50%] to-[50%] to-[#fff]'>
      <div
        className='xl:container bg-[#5437CC] flex flex-col  xl:flex-row items-center justify-between gap-12 py-9 xl:p-14 pl-0 rounded-bl-[420px] rounded-br-[420px] 
