...
const FeatureCard: React.FC<FeatureCardType> = ({ feature }) => {
  return (
    <div>
      <div className="grid grid-cols-1 md:grid-cols-2   gap-8  mb-14 sb">
        <div className="flex flex-col  justify-between gap-4  px-3">
          <h4 className="font-semibold">{feature?.title}</h4>

          <p className="text-2xl 2xl:w-[509px]">{feature?.description}</p>
        </div>
        <div className="relative order-first 2xl:order-last w-full sm:w-[366px]  h-[240px] xl:w-full   xl:h-[457px]  ">
